...
class CreateRequirementForm extends StatefulWidget {
  ...
  final Function(TravelModel, GroupModel) onCreate;
...
class _CreateRequirementFormState extends State<CreateRequirementForm> {
  ...
  final List<String> descriptionOptions = [
    'Looking for a Solo Travel Companion',
    'Looking for a Travelling Group',
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate() &&
        ...
        latitude != null &&
        longitude != null) {
      final eventId = "event${travelData.length + 1}";
      ...
      final newRequirement = TravelModel(
        id: eventId,
        sportName: sportName!,
